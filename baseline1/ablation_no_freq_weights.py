...
STATS = RunStats()
ABLATION_NAME = "No frequency weights"
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the no-frequency-weights ablation experiment.")
